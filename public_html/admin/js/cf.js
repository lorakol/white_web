...
function selectCFType(val, f_type) {
	...
	//div_min, div_max
	if(selected_val=="textbox" || selected_val=="phone" || selected_val=="whatsapp" || selected_val=="textarea" || selected_val=="htmlarea" || selected_val=="button") {
		$("#div_min").show();
		$("#div_max").show();
	...
	//div_length
	if(selected_val=="textbox" || selected_val=="textarea" || selected_val=="htmlarea" || selected_val=="youtube" || selected_val=="url" || selected_val=="email" || selected_val=="date" || selected_val=="multiselect" || selected_val=="terms" || selected_val=="phone" || selected_val=="twitter" || selected_val=="price" || selected_val=="button") {
		$("#div_length").show();
	}
	else
		$("#div_length").hide();
	...
	if(selected_val=="textarea" || selected_val=="htmlarea" || selected_val=="button") {
	...
	// admin_verification
	// only for : textbox, textarea, htmlarea, url,
	// twitter, file, image, logo, youtube, video, audio
	if(selected_val=="textbox" || selected_val=="textarea" || selected_val=="htmlarea" || selected_val=="url" || selected_val=="twitter" || selected_val=="file" || selected_val=="image" || selected_val=="logo" || selected_val=="youtube" || selected_val=="video" || selected_val=="audio" || selected_val=="button") {
		$("#div_admin_verification").show();
	}
	else {
		$("#div_admin_verification").hide();
	}
	...
	if( selected_val!="image" && selected_val!="logo" && selected_val!="file" && selected_val!="google_maps" && selected_val!="youtube" && selected_val!="checkbox_group" &&  selected_val!="radio_group" &&  selected_val!="video" &&  selected_val!="audio") {
		...
		if( selected_val=="checkbox_group" ||  selected_val!="radio_group") {
	...
	// public user choice
	if( selected_val=="textbox" || selected_val=="textarea" || selected_val=="htmlarea" || selected_val=="menu" || selected_val=="url" || selected_val=="phone" || selected_val=="email" || selected_val=="date" || selected_val=="whatsapp" || selected_val=="user_email" || selected_val=="twitter" || selected_val=="button")
		$("#uc").show();
	else
		$("#uc").hide();
