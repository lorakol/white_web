...
if(!isset($config_admin_folder) || !$config_admin_folder) $config_admin_folder="admin";
...
require_once $config_abs_path.'/'.$config_admin_folder.'/include/util.php';
...
$lang='lang/'.$lang.'.php';
require_once $config_abs_path.'/'.$config_admin_folder.'/'.$lang;
