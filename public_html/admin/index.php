...
$uf = new fields("uf");
$users['verification']=0;
$admin_verification_exists=0;
if($uf->getAdminVerificationExists()) {

	$users['verification']=$usr->getNoAdminVerificationUsers();
	$admin_verification_exists=1;
