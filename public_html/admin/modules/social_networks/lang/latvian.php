<?php
$lng_sn['social_networks'] = 'Sociālie tīkli';
$lng_sn['facebook_page_link']='Tava <i>Facebook</i> lapa';
$lng_sn['twitter_account']='Tavs <i>Twitter</i> konts';

$lng_sn['fb_like_button']='Facebook <i>Patīk</i> poga';
$lng_sn['tweet_button']='<i>Tweet</i> poga';
$lng_sn['fb_recent_activity']='Facebook <i>Jaunākās aktivitātes</i> spraudnis';

$lng_sn['fb_ra_width']='Platums';
$lng_sn['fb_ra_height']='Augstums';
$lng_sn['fb_ra_color']='Krāsu shēma';
$lng_sn['fb_ra_show_recommendations']='Rādīt rekomendācijas';
$lng_sn['info']['fb_ra_show_recommendations']='Spraudnis tiks piepildīts ar aktivitātēm no draugu saraksta, ja jūs to aktivizēsiet.';

$lng_sn['fb_lb_layout']='Izkārtojuma stils';
$lng_sn['fb_lb_show_faces']='Rādīt sejas';
$lng_sn['fb_lb_width']='Platums';
$lng_sn['fb_lb_action']='Attēlot vārdu';
$lng_sn['fb_lb_color']='Krāsu shēma';
$lng_sn['fb_lb_locale'] = 'Valoda';

$lng_sn['info']['fb_lb_show_faces']='Rādīt profila fotogrāfijas zem pogas (standarta izkārtojumiem tikai)';

$lng_sn['tw_data_count']='Pogas tips';
$lng_sn['tw_data_text']='Tweet teksts';
$lng_sn['info']['tw_data_text']='Nosūtītais teksts kā tweets. Pārliecinies kā izmērs ir 140 csimboli. Tags ##TITLE## tisk pārveidots par sludinājuma nosaukumu.';

$lng_sn["tweet_ads"] = "Tweetot sludinājumus, kad pievienoti";
$lng_sn['error']['enable_tweet_ads'] = 'Lai iespējotu iespēju Tweetot sludinājumus, jums ir jāsniedz šāda informācija: lietotāja atslēga, Patērētāju slepenā Piekļuves pilnvara un piekļuves pilnvara atslēga!';
$lng_sn["tw_consumer_key"] = "Lietotāja atslēga";
$lng_sn["tw_consumer_secret"] = "Lietotāja slepenais kods";
$lng_sn["tw_access_token"] = "Piekļuves pilnvaras";
$lng_sn["tw_access_token_secret"] = "Piekļuves pilnvaras slepenais kods";

$lng_sn['gplus_button'] = 'Google +1';
$lng_sn['gplus_size'] = 'Size';
$lng_sn['gplus_language'] = 'Valoda';

$lng_sn['fb_like_box'] = 'Facebook Patīk kaste';
$lng_sn['fb_show_stream'] = 'Rādīt plūsmu';
$lng_sn['fb_show_header'] = 'Rādīt galveni';

$lng_sn['info']['fb_lbox_show_faces']='Rādīt profila fotogrāfijas spraudnī.';
$lng_sn['info']['fb_show_stream'] = 'Rādīt profila plūsmu publiskājā profilā.';
$lng_sn['info']['fb_show_header'] = 'Rādīt \'Atrodi mūs Facebook\' Joslas augšā. Parādīt tikai tad, kad plūsma vai sejas ir klāt.';
