...
$lng_sn['fb_secret'] = 'Facebook App Secret';
$lng_sn['fb_access_token'] = 'Facebook User Access Token';
$lng_sn['fb_page_access_token'] = 'Facebook Page Access Token';
$lng_sn['get_fb_access_token'] = 'Get Facebook Page Access Token!';
...
$lng_sn['info']['access_token_helper'] = 'Please follow the next steps in order to get the Facebook page access token.';
$lng_sn['step1'] = '<b>Step1:</b> Access the Graph API Explorer URL';
$lng_sn['step2'] = '<b>Step2:</b> In the Graph API Explorer page, to the right side of the page select the correct <em>Facebook App</em>, then select for <em>User or Page</em> <b>User Token</b>. Copy the <b>Access Token</b> from the top right side of the page and enter it below, then click on <b>Get Facebook Page Access Token</b> button.';
$lng_sn['code']='Access Token';
$lng_sn['error']['code']='Please enter the Access Token you copied in the previous step!';
...
$lng_sn['info']['pageid'] = 'The Facebook Page ID where you want the ads posted to. To find out your Page id, go to your Page and click<br/> <b>About</b> in the left column. If you do not see the About in the left column, click See More';
