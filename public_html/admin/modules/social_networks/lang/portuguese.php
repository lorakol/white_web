<?php
$lng_sn['social_networks'] = 'Redes Sociais';
$lng_sn['facebook_page_link']='Seu <i> Facebook </ i> Pagina';
$lng_sn['twitter_account']='Seu <i> Twitter </ i> conta';

$lng_sn['fb_like_button']='Facebook <i> Gosta </ i> botao';
$lng_sn['tweet_button']='<i>Tweet</i> botao';
$lng_sn['fb_recent_activity']='Facebook <i>Atividade Recente</i> plugin';

$lng_sn['fb_ra_width']='Largura';
$lng_sn['fb_ra_height']='Altura';
$lng_sn['fb_ra_color']='Esquema de cores';
$lng_sn['fb_ra_show_recommendations']='Mostrar Recomendacoes';
$lng_sn['info']['fb_ra_show_recommendations']='O plugin e preenchido com a actividade de amigos do usuario \'s. Se nao houver atividade amigo o suficiente para encher o plugin, ele esta de volta cheio de recomendacoes, se voce habilita-lo.';

$lng_sn['fb_lb_layout']='Estilo do Esquema';
$lng_sn['fb_lb_show_faces']='Mostrar caras';
$lng_sn['fb_lb_width']='Largura';
$lng_sn['fb_lb_action']='Verbo para exibir';
$lng_sn['fb_lb_color']='Esquema de cores';
$lng_sn['fb_lb_locale'] = 'Idioma';

$lng_sn['info']['fb_lb_show_faces']='Mostrar fotos de perfil abaixo do botao (layout padrao apenas)';

$lng_sn['tw_data_count']='Tipo de botao';
$lng_sn['tw_data_text']='Tweet texto';
$lng_sn['info']['tw_data_text']='O texto enviado como um tweet. Certifique-se de limitar o tamanho de 140 caracteres. A tag # TITLE # # # sera substituido com o titulo do anuncio.';

$lng_sn["tweet_ads"] = "Anuncios Tweet quando postadas";
$lng_sn['error']['enable_tweet_ads'] = 'Para habilitar a opcao de permitir anuncios Tweet voce deve fornecer todas as informacoes seguintes: Chave do Consumidor, Segredo do Consumidor, token de acesso e de acesso secreto simbolo!';
$lng_sn["tw_consumer_key"] = "Chave do Consumidor";
$lng_sn["tw_consumer_secret"] = "Segredo do Consumidor";
$lng_sn["tw_access_token"] = "Acesse simbolo";
$lng_sn["tw_access_token_secret"] = "Acesse segredo simbolo";

$lng_sn['gplus_button'] = 'Google +1';
$lng_sn['gplus_size'] = 'Tamanho';
$lng_sn['gplus_language'] = 'Lingua';

$lng_sn['fb_like_box'] = 'Facebook Like Box';
$lng_sn['fb_show_stream'] = 'Mostrar Stream';
$lng_sn['fb_show_header'] = 'Mostrar header';

$lng_sn['info']['fb_lbox_show_faces']='Mostrar fotos de perfil no plugin';
$lng_sn['info']['fb_show_stream'] = 'Mostrar o fluxo de perfil para o perfil publico.';
$lng_sn['info']['fb_show_header'] = 'Mostrar o \'Encontre-nos no Facebook \' barra na parte superior. So e apresentado quando um corrego ou rostos estao presentes.';
...
// ---------- version 9.8 ----------------
$lng_sn['pinterest_button']='Pinterest button';
$lng_sn['linkedin_button']='Linkedin button';

// ---------- end version 9.8 ----------------

// ---------- version 9.9 ----------------

$lng_sn['info']['appid'] = 'The following of the below features will need a Facebook APP Id: <b>Facebook Page Plugin</b>,<br/> <b>FaceBook like button</b>, <b>FaceBook Comments</b>, <b>Post Ads on FaceBook</b>';
$lng_sn['info']['access_token'] = 'Use the button <b>Get FaceBook Access Token</b> button in order to generate User Access Token and Page Access Token';
$lng_sn['error']['enter_field_for_token'] = 'Please enter the following required information: FaceBook App Id, Facebook Page Id, Facebook App secret';
// ---------- end version 9.9 ----------------
