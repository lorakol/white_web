...
//		if(!$user_contact) $user_contact=$username;
	...
	function getActiveUserSubscriptions($user_id, $category_id='') {
		...
		$where_str = '';
		if($category_id)  $where_str = " and ( ".TABLE_PACKAGES.".`categories` REGEXP CONCAT('(^|,)(', REPLACE('$category_id', ',', '|'), ')(,|$)') or `categories` = 0 ) ";
