...
class settings {
	...
	static function getAppearance() {
		...
		$array['header_pic_width'] = $array['header_pic_height'] = 0;
		if($array['header_pic']) {
		...
		$array['small_header_pic_width'] = $array['small_header_pic_height'] = 0;
		if($array['small_header_pic']) {
		...
		$array['footer_pic_width'] = $array['footer_pic_height'] = 0;
		if($array['footer_pic']) {
