...
class payment {
	...
	function addActions($invoice_no) {
		...
		do_action("payment_add_action", array($this->actions_array, &$type, $object_id, $this->user_id, $invoice_no, $this->pending));
	...
	function process()
	{
		...
		else $this->setInfo($lng['payments']['invalid_transaction']);
