...
class paginator {
	...
	function paginate(&$smarty) {
		...
		global $config_live_site, $config_admin_folder;
		global $seo_settings, $ads_settings;
	
		if($this->admin) $this->live_site = $config_live_site.'/'.$config_admin_folder; else $this->live_site = $config_live_site;
