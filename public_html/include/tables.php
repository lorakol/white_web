...
define('TABLE_AFFILIATES', $config_table_prefix.'affiliates');
define('TABLE_AFFILIATES_REVENUE', $config_table_prefix.'affiliates_revenue');
define('TABLE_AFFILIATES_PAYMENTS', $config_table_prefix.'affiliates_payments');
...
define('TABLE_BLOCKED_EMAILS',$config_table_prefix.'blocked_emails');
define('TABLE_CATEGORIES', $config_table_prefix.'categories');
define('TABLE_COUPONS',$config_table_prefix.'coupons');
define('TABLE_CREDITS_SETTINGS',$config_table_prefix.'credits_settings');
define('TABLE_CREDITS_PACKAGES',$config_table_prefix.'credits_packages');
...
define('TABLE_FLAGGED_IPS',$config_table_prefix.'flagged_ips');
...
define('TABLE_PERIODIC', $config_table_prefix.'periodic');
...
define('TABLE_SEO_PAGES',$config_table_prefix.'seo_pages');
define('TABLE_SETTINGS', $config_table_prefix.'settings');
define('TABLE_SITEMAP', $config_table_prefix.'sitemap'); 
define('TABLE_SLUGS', $config_table_prefix.'slugs'); 
define('TABLE_SMS_GATEWAYS', $config_table_prefix.'sms_gateways'); 
define('TABLE_TEMP_IPORT', $config_table_prefix.'temp_import'); 
define('TABLE_USER_FIELDS',$config_table_prefix.'user_fields');
define('TABLE_USER_GROUPS',$config_table_prefix.'user_groups');
define('TABLE_USER_KEYS', $config_table_prefix.'user_keys');
...
define('TABLE_MESSAGES', $config_table_prefix.'messages'); 
define('TABLE_RULES', $config_table_prefix.'rules');
define('TABLE_LOCATION_NO_ADS', $config_table_prefix.'location_no_ads');
define('TABLE_CATEGORIES_NO_ADS', $config_table_prefix.'categories_no_ads');
define('TABLE_MOBILE_SETTINGS', $config_table_prefix.'mobile_settings');
define('TABLE_SCHEDULED_IMPORTS', $config_table_prefix.'scheduled_imports');
define('TABLE_PENDING_EDITED', $config_table_prefix.'pending_edited');
define('TABLE_AUCTIONS', $config_table_prefix.'auctions');
define('TABLE_BIDS', $config_table_prefix.'bids');
define('TABLE_SECURITY_SETTINGS', $config_table_prefix.'security_settings');
define('TABLE_FAILED_ATTEMPTS', $config_table_prefix.'failed_attempts');
define('TABLE_WHITELIST_IPS', $config_table_prefix.'whitelist_ips');
define('TABLE_WHITELIST_EMAILS', $config_table_prefix.'whitelist_emails');
define('TABLE_INVOICE_SETTINGS', $config_table_prefix.'invoice_settings');
define('TABLE_INVOICES', $config_table_prefix.'invoices');
define('TABLE_BLOCKED_PHONES',$config_table_prefix.'blocked_phones');
define('TABLE_WHITELIST_PHONES', $config_table_prefix.'whitelist_phones');
define('TABLE_SEARCHES', $config_table_prefix.'searches');
define('TABLE_ADS_VIDEOS', $config_table_prefix.'ads_videos');
define('TABLE_FEATURED_PLANS', $config_table_prefix.'featured_plans');
define('TABLE_FEATURED2_PLANS', $config_table_prefix.'featured2_plans');
?>